    ...
    if ($n.ContainsKey('OIT') -and $n.ContainsKey('snap')) {
        ...
        if ($true) {
            if ($n['sweep'] -gt 0 -and $vao -ge $n['sweep']) {
                ...
                Anotar '   >>> A Oldest transaction esta PRESA: ha uma transacao velha'
                Anotar '   >>> que nunca fechou, e a varredura nao consegue passar'
                Anotar '   >>> dela. Entao toda vez ela refaz a MESMA varredura, do'
                Anotar '   >>> mesmo ponto, e trava pelo MESMO tempo - que e por que'
                Anotar '   >>> as quedas desta casa tem sempre 6 a 7 minutos.'
                Anotar '   >>>'
                Anotar '   >>> O CONSERTO NAO E REINICIAR. E, em ordem:'
                Anotar '   >>>   1. achar o que segura a transacao velha (tela do'
                Anotar '   >>>      Delphi aberta a semanas, programa que conectou e'
                Anotar '   >>>      nao fechou) e fecha-lo;'
                Anotar '   >>>   2. rodar UMA varredura completa de madrugada, a mao'
                Anotar '   >>>      (gfix -sweep), junto do backup das 03:00;'
                Anotar '   >>>   3. so entao desligar a varredura automatica'
                Anotar '   >>>      (gfix -h 0), para ela nunca mais disparar no'
                Anotar '   >>>      horario de trabalho.'
                Anotar '   >>>'
                Anotar '   >>> NADA DISSO E FEITO POR ESTE SCRIPT. Ele so mede.'
            } elseif ($n['sweep'] -gt 0) {
                $falta = $n['sweep'] - $vao
