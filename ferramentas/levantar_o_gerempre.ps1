    ...
    if ($n.ContainsKey('OIT') -and $n.ContainsKey('snap')) {
        ...
        if ($true) {
            if ($n['sweep'] -gt 0 -and $vao -ge $n['sweep']) {
                ...
                Anotar '   >>>   1. gfix -list: ver se a transacao parada esta em LIMBO.'
                Anotar '   >>>      Limbo nao sai com varredura nenhuma, e prende a'
                Anotar '   >>>      Oldest transaction para sempre;'
                Anotar '   >>>   2. o cache: Page buffers em 0 quer dizer o padrao, que'
                Anotar '   >>>      aqui da 2 MB para um banco de 153 MB. A varredura'
                Anotar '   >>>      le tudo do disco, pagina por pagina;'
                Anotar '   >>>   3. UMA varredura completa de madrugada, a mao'
                Anotar '   >>>      (gfix -sweep), junto do backup das 03:00;'
                Anotar '   >>>   4. so entao desligar a varredura automatica'
                Anotar '   >>>      (gfix -h 0), para ela nunca disparar no horario'
                Anotar '   >>>      de trabalho.'
                Anotar '   >>>'
